...
<%
    ...
    SecureRandom secureRandom = new SecureRandom(); // 使用 SecureRandom 替代 Random
    StringBuilder captchaCode = new StringBuilder();

    for (int i = 0; i < codeLength; i++) {
        captchaCode.append(characters.charAt(secureRandom.nextInt(characters.length())));
    }
    ...
    for (int i = 0; i < 6; i++) {
        ...
        int x2 = x1 + secureRandom.nextInt(maxLineLength);
        int y2 = y1 + secureRandom.nextInt(maxLineLength);
